...
function Sidebar() {
  ...
  // Default to collapsed for everyone as per request "side menu bar is default closed"
  // This effectively makes it behave like the mobile drawer for all users.
  const sidebarCollapsed = true;

  // Remove resize listener that forces it closed on desktop, 
  // since we want it closed by default and openable on demand.
  /* 
  useEffect(() => {
    const handleResize = () => {
  ...
  */
  ...
  // const forceCollapsedForStudent = isStudent; // No longer needed as we force it for everyone
  // const sidebarCollapsed = true; // Already defined above
