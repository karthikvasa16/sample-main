      ...
      >
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{ height: '6px', borderRadius: '999px', backgroundColor: '#e2e8f0', overflow: 'hidden' }}>
            <div style={{ width: `${progress}%`, background: 'linear-gradient(135deg, #4f46e5 0%, #22d3ee 100%)', height: '100%' }} />
          </div>
        </div>
        ...
        <section id="loan-plan" style={{ marginBottom: '2.75rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.75rem', alignItems: 'stretch' }}>
          <div style={{
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  height: '8px',
                  borderRadius: '4px',
                  background: 'linear-gradient(to right, #4f46e5 0%, #22d3ee 100%)',
                  outline: 'none',
                  cursor: 'pointer'
                }}
              />
            ...
            {loanIntent && !plannerMessage && (
              <p style={{ color: '#16a34a', fontSize: '0.85rem', marginTop: '0.85rem' }}>
              ...
              <div key={program.id} style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '0.9rem',
                    border: 'none',
                    background: isSelected ? program.accent : 'linear-gradient(135deg, #4f46e5 0%, #22d3ee 100%)',
                    color: 'white',
                    fontWeight: 600,
                    cursor: 'pointer'
                  }}
