  ...
  const metricCards = useMemo(() => ([
    {
      ...
      subtitle: `${metrics.totalAdmins || 0} admins · ${metrics.totalStudents || 0} students`,
      color: '#2563eb'
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      subtitle: `${metrics.unverifiedUsers || 0} pending verification`,
      color: '#16a34a'
    },
    {
      icon: UserMinus,
      title: 'Accounts Deleted',
      value: metrics.deletedAccounts,
      subtitle: `${metrics.localUsers || 0} active native accounts`,
      color: '#dc2626'
    }
  ]), [metrics]);
