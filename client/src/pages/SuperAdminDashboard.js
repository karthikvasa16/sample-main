        ...
        <>
          ...
          <section style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
              <h2 style={{ fontSize: '1.1rem', fontWeight: 600, color: '#0f172a' }}>Recent Activity</h2>
              <a href="/superadmin/activities" style={{ color: '#2563eb', fontSize: '0.9rem', fontWeight: 500, textDecoration: 'none' }}>View All</a>
            </div>
