...
import { FileText, CheckCircle, DollarSign, TrendingUp, Clock, CreditCard, AlertCircle, Users, ArrowUpRight, ArrowDownRight, Activity } from 'lucide-react';
...
function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const cibilDist = [
        { name: 'Excellent', value: loans.filter(l => l.cibilScore >= 750).length, color: '#10b981', range: '750+' },
        { name: 'Good', value: loans.filter(l => l.cibilScore >= 650 && l.cibilScore < 750).length, color: '#3b82f6', range: '650-749' },
    ...
    <div style={{ 
      ...
      >
        <StatCard
          ...
          color="#3b82f6"
          gradient="linear-gradient(135deg, #3b82f615 0%, #3b82f605 100%)"
        />
        <StatCard
          icon={FileText}
          ...
          color="#8b5cf6"
          gradient="linear-gradient(135deg, #8b5cf615 0%, #8b5cf605 100%)"
        />
        <StatCard
          icon={AlertCircle}
          ...
          change={null}
          color="#f59e0b"
          gradient="linear-gradient(135deg, #f59e0b15 0%, #f59e0b05 100%)"
        />
        <StatCard
          icon={CheckCircle}
        ...
        <StatCard
          ...
          color="#ec4899"
          gradient="linear-gradient(135deg, #ec489915 0%, #ec489905 100%)"
        />
        <StatCard
          icon={CreditCard}
          ...
          change={null}
          color="#06b6d4"
          gradient="linear-gradient(135deg, #06b6d415 0%, #06b6d405 100%)"
        />
      </div>
          ...
          {recentLoans.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxHeight: '450px', overflowY: 'auto', paddingRight: '0.5rem' }}>
              {recentLoans.map((loan) => {
                const statusColor = loan.status === 'Approved' ? '#10b981' : loan.status === 'Pending' ? '#f59e0b' : '#ef4444';
                const statusBg = loan.status === 'Approved' ? '#d1fae5' : loan.status === 'Pending' ? '#fef3c7' : '#fee2e2';
                        ...
                        <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap', marginTop: '0.75rem' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                            ...
                            <span style={{ fontSize: '0.8125rem', color: '#475569' }}>
                              CIBIL: <strong style={{ 
                                color: loan.cibilScore >= 750 ? '#10b981' : loan.cibilScore >= 650 ? '#3b82f6' : '#f59e0b',
                                fontWeight: '700'
                              }}>
                                {loan.cibilScore}
                              </strong>
